...
CREATE SEQUENCE testnet.ada_pots_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.ada_pots_id_seq OWNED BY testnet.ada_pots.id;
...
CREATE SEQUENCE testnet.block_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.block_id_seq OWNED BY testnet.block.id;
...
CREATE TABLE testnet.cost_model (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.cost_model_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.cost_model_id_seq OWNED BY testnet.cost_model.id;
...
CREATE SEQUENCE testnet.datum_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.datum_id_seq OWNED BY testnet.datum.id;
...
CREATE TABLE testnet.delegation (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.delegation_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.delegation_id_seq OWNED BY testnet.delegation.id;
...
CREATE TABLE testnet.delisted_pool (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.delisted_pool_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.delisted_pool_id_seq OWNED BY testnet.delisted_pool.id;
...
CREATE SEQUENCE testnet.epoch_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.epoch_id_seq OWNED BY testnet.epoch.id;
...
CREATE TABLE testnet.epoch_param (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.epoch_param_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.epoch_param_id_seq OWNED BY testnet.epoch_param.id;
...
CREATE TABLE testnet.epoch_stake (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.epoch_stake_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.epoch_stake_id_seq OWNED BY testnet.epoch_stake.id;
...
CREATE TABLE testnet.epoch_sync_time (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    no bigint NOT NULL,
...
CREATE SEQUENCE testnet.epoch_sync_time_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.epoch_sync_time_id_seq OWNED BY testnet.epoch_sync_time.id;
...
CREATE TABLE testnet.extra_key_witness (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.extra_key_witness_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.extra_key_witness_id_seq OWNED BY testnet.extra_key_witness.id;
...
CREATE TABLE testnet.ma_tx_mint (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.ma_tx_mint_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.ma_tx_mint_id_seq OWNED BY testnet.ma_tx_mint.id;
...
CREATE TABLE testnet.ma_tx_out (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    quantity numeric(20,0) NOT NULL,
    ident bigint NOT NULL,
...
CREATE SEQUENCE testnet.ma_tx_out_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.ma_tx_out_id_seq OWNED BY testnet.ma_tx_out.id;
...
CREATE SEQUENCE testnet.meta_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.meta_id_seq OWNED BY testnet.meta.id;
...
CREATE TABLE testnet.multi_asset (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.multi_asset_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.multi_asset_id_seq OWNED BY testnet.multi_asset.id;
...
CREATE TABLE testnet.param_proposal (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.param_proposal_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.param_proposal_id_seq OWNED BY testnet.param_proposal.id;
...
CREATE TABLE testnet.pool_hash (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    hash_raw character varying(56) NOT NULL,
...
CREATE SEQUENCE testnet.pool_hash_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_hash_id_seq OWNED BY testnet.pool_hash.id;
...
CREATE TABLE testnet.pool_metadata_ref (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    hash character varying(64) NOT NULL,
...
CREATE SEQUENCE testnet.pool_metadata_ref_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_metadata_ref_id_seq OWNED BY testnet.pool_metadata_ref.id;
...
CREATE TABLE testnet.pool_offline_data (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    bytes bytea,
    hash character varying(64) NOT NULL,
...
CREATE SEQUENCE testnet.pool_offline_data_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_offline_data_id_seq OWNED BY testnet.pool_offline_data.id;
...
CREATE TABLE testnet.pool_offline_fetch_error (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.pool_offline_fetch_error_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_offline_fetch_error_id_seq OWNED BY testnet.pool_offline_fetch_error.id;
...
CREATE TABLE testnet.pool_owner (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.pool_owner_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_owner_id_seq OWNED BY testnet.pool_owner.id;
...
CREATE TABLE testnet.pool_relay (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.pool_relay_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_relay_id_seq OWNED BY testnet.pool_relay.id;
...
CREATE TABLE testnet.pool_retire (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    cert_index integer NOT NULL,
...
CREATE SEQUENCE testnet.pool_retire_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_retire_id_seq OWNED BY testnet.pool_retire.id;
...
CREATE TABLE testnet.pool_stake (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    amount numeric(19,2),
    pool_id bigint
...
CREATE SEQUENCE testnet.pool_stake_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_stake_id_seq OWNED BY testnet.pool_stake.id;
...
CREATE TABLE testnet.pool_update (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    active_epoch_no bigint NOT NULL,
    cert_index integer NOT NULL,
...
CREATE SEQUENCE testnet.pool_update_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pool_update_id_seq OWNED BY testnet.pool_update.id;
...
CREATE TABLE testnet.pot_transfer (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    cert_index integer NOT NULL,
    reserves numeric(20,0) NOT NULL,
...
CREATE SEQUENCE testnet.pot_transfer_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.pot_transfer_id_seq OWNED BY testnet.pot_transfer.id;
...
CREATE TABLE testnet.redeemer_data (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    bytes bytea,
    hash character varying(64) NOT NULL,
...
CREATE SEQUENCE testnet.redeemer_data_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.redeemer_data_id_seq OWNED BY testnet.redeemer_data.id;
...
CREATE SEQUENCE testnet.redeemer_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.redeemer_id_seq OWNED BY testnet.redeemer.id;
...
CREATE TABLE testnet.reference_tx_in (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.reference_tx_in_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.reference_tx_in_id_seq OWNED BY testnet.reference_tx_in.id;
...
CREATE SEQUENCE testnet.reserve_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.reserve_id_seq OWNED BY testnet.reserve.id;
...
CREATE TABLE testnet.reserved_pool_ticker (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.reserved_pool_ticker_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.reserved_pool_ticker_id_seq OWNED BY testnet.reserved_pool_ticker.id;
...
CREATE SEQUENCE testnet.reward_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.reward_id_seq OWNED BY testnet.reward.id;
...
CREATE TABLE testnet.schema_version (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.schema_version_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.schema_version_id_seq OWNED BY testnet.schema_version.id;
...
CREATE SEQUENCE testnet.script_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.script_id_seq OWNED BY testnet.script.id;
...
CREATE TABLE testnet.slot_leader (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.slot_leader_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.slot_leader_id_seq OWNED BY testnet.slot_leader.id;
...
CREATE TABLE testnet.stake_address (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.stake_address_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.stake_address_id_seq OWNED BY testnet.stake_address.id;
...
CREATE TABLE testnet.stake_deregistration (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    cert_index integer NOT NULL,
    epoch_no integer NOT NULL,
...
CREATE SEQUENCE testnet.stake_deregistration_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.stake_deregistration_id_seq OWNED BY testnet.stake_deregistration.id;
...
CREATE TABLE testnet.stake_registration (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    cert_index integer NOT NULL,
    epoch_no integer NOT NULL,
...
CREATE SEQUENCE testnet.stake_registration_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.stake_registration_id_seq OWNED BY testnet.stake_registration.id;
...
CREATE SEQUENCE testnet.treasury_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.treasury_id_seq OWNED BY testnet.treasury.id;
...
CREATE SEQUENCE testnet.tx_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.tx_id_seq OWNED BY testnet.tx.id;
...
CREATE SEQUENCE testnet.tx_in_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.tx_in_id_seq OWNED BY testnet.tx_in.id;
...
CREATE TABLE testnet.tx_metadata (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    bytes bytea,
    json character varying(65535),
...
CREATE SEQUENCE testnet.tx_metadata_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.tx_metadata_id_seq OWNED BY testnet.tx_metadata.id;
...
CREATE TABLE testnet.failed_tx_out (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
...
CREATE SEQUENCE testnet.failed_tx_out_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.failed_tx_out_id_seq OWNED BY testnet.failed_tx_out.id;
...
CREATE SEQUENCE testnet.tx_out_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.tx_out_id_seq OWNED BY testnet.tx_out.id;


--
-- Name: unconsume_tx_in; Type: TABLE; Schema: dev; Owner: cardano-master
--

CREATE TABLE testnet.unconsume_tx_in (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    tx_out_index smallint NOT NULL,
    tx_in_id bigint NOT NULL,
...
CREATE SEQUENCE testnet.unconsume_tx_in_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.unconsume_tx_in_id_seq OWNED BY testnet.unconsume_tx_in.id;
...
CREATE TABLE testnet.withdrawal (
    id bigint NOT NULL,
    is_deleted boolean DEFAULT false,
    amount numeric(20,0) NOT NULL,
    addr_id bigint NOT NULL,
...
CREATE SEQUENCE testnet.withdrawal_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE testnet.withdrawal_id_seq OWNED BY testnet.withdrawal.id;
...
ALTER TABLE ONLY testnet.ada_pots ALTER COLUMN id SET DEFAULT nextval('testnet.ada_pots_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.block ALTER COLUMN id SET DEFAULT nextval('testnet.block_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.cost_model ALTER COLUMN id SET DEFAULT nextval('testnet.cost_model_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.datum ALTER COLUMN id SET DEFAULT nextval('testnet.datum_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.delegation ALTER COLUMN id SET DEFAULT nextval('testnet.delegation_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.delisted_pool ALTER COLUMN id SET DEFAULT nextval('testnet.delisted_pool_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.epoch ALTER COLUMN id SET DEFAULT nextval('testnet.epoch_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.epoch_param ALTER COLUMN id SET DEFAULT nextval('testnet.epoch_param_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.epoch_stake ALTER COLUMN id SET DEFAULT nextval('testnet.epoch_stake_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.epoch_sync_time ALTER COLUMN id SET DEFAULT nextval('testnet.epoch_sync_time_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.extra_key_witness ALTER COLUMN id SET DEFAULT nextval('testnet.extra_key_witness_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.ma_tx_mint ALTER COLUMN id SET DEFAULT nextval('testnet.ma_tx_mint_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.ma_tx_out ALTER COLUMN id SET DEFAULT nextval('testnet.ma_tx_out_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.meta ALTER COLUMN id SET DEFAULT nextval('testnet.meta_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.multi_asset ALTER COLUMN id SET DEFAULT nextval('testnet.multi_asset_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.param_proposal ALTER COLUMN id SET DEFAULT nextval('testnet.param_proposal_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_hash ALTER COLUMN id SET DEFAULT nextval('testnet.pool_hash_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_metadata_ref ALTER COLUMN id SET DEFAULT nextval('testnet.pool_metadata_ref_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_offline_data ALTER COLUMN id SET DEFAULT nextval('testnet.pool_offline_data_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_offline_fetch_error ALTER COLUMN id SET DEFAULT nextval('testnet.pool_offline_fetch_error_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_owner ALTER COLUMN id SET DEFAULT nextval('testnet.pool_owner_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_relay ALTER COLUMN id SET DEFAULT nextval('testnet.pool_relay_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_retire ALTER COLUMN id SET DEFAULT nextval('testnet.pool_retire_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_stake ALTER COLUMN id SET DEFAULT nextval('testnet.pool_stake_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pool_update ALTER COLUMN id SET DEFAULT nextval('testnet.pool_update_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.pot_transfer ALTER COLUMN id SET DEFAULT nextval('testnet.pot_transfer_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.redeemer ALTER COLUMN id SET DEFAULT nextval('testnet.redeemer_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.redeemer_data ALTER COLUMN id SET DEFAULT nextval('testnet.redeemer_data_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.reference_tx_in ALTER COLUMN id SET DEFAULT nextval('testnet.reference_tx_in_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.reserve ALTER COLUMN id SET DEFAULT nextval('testnet.reserve_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.reserved_pool_ticker ALTER COLUMN id SET DEFAULT nextval('testnet.reserved_pool_ticker_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.reward ALTER COLUMN id SET DEFAULT nextval('testnet.reward_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.schema_version ALTER COLUMN id SET DEFAULT nextval('testnet.schema_version_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.script ALTER COLUMN id SET DEFAULT nextval('testnet.script_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.slot_leader ALTER COLUMN id SET DEFAULT nextval('testnet.slot_leader_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.stake_address ALTER COLUMN id SET DEFAULT nextval('testnet.stake_address_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.stake_deregistration ALTER COLUMN id SET DEFAULT nextval('testnet.stake_deregistration_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.stake_registration ALTER COLUMN id SET DEFAULT nextval('testnet.stake_registration_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.treasury ALTER COLUMN id SET DEFAULT nextval('testnet.treasury_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.tx ALTER COLUMN id SET DEFAULT nextval('testnet.tx_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.tx_in ALTER COLUMN id SET DEFAULT nextval('testnet.tx_in_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.tx_metadata ALTER COLUMN id SET DEFAULT nextval('testnet.tx_metadata_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.tx_out ALTER COLUMN id SET DEFAULT nextval('testnet.tx_out_id_seq'::regclass);


--
-- Name: failed_tx_out id; Type: DEFAULT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out ALTER COLUMN id SET DEFAULT nextval('testnet.failed_tx_out_id_seq'::regclass);


--
-- Name: unconsume_tx_in id; Type: DEFAULT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.unconsume_tx_in ALTER COLUMN id SET DEFAULT nextval('testnet.unconsume_tx_in_id_seq'::regclass);
...
ALTER TABLE ONLY testnet.withdrawal ALTER COLUMN id SET DEFAULT nextval('testnet.withdrawal_id_seq'::regclass);
...
COPY testnet.ada_pots (id, is_deleted, deposits, epoch_no, fees, reserves, rewards, slot_no, treasury, utxo, block_id) FROM stdin;
\.
...
COPY testnet.block (id, is_deleted, block_no, epoch_no, epoch_slot_no, hash, op_cert, op_cert_counter, proto_major, proto_minor, size, slot_leader_id, slot_no, "time", tx_count, vrf_key, previous_id) FROM stdin;
...
COPY testnet.cost_model (id, is_deleted, costs, hash, block_id) FROM stdin;
\.
...
COPY testnet.datum (id, is_deleted, bytes, hash, value, tx_id) FROM stdin;
\.
...
COPY testnet.delegation (id, is_deleted, active_epoch_no, cert_index, slot_no, addr_id, pool_hash_id, redeemer_id, tx_id) FROM stdin;
\.
...
COPY testnet.delisted_pool (id, is_deleted, hash_raw) FROM stdin;
\.
...
COPY testnet.epoch (id, is_deleted, blk_count, end_time, fees, max_slot, no, out_sum, start_time, tx_count) FROM stdin;
\.
...
COPY testnet.epoch_stake (id, is_deleted, amount, epoch_no, addr_id, pool_id) FROM stdin;
\.
...
COPY testnet.epoch_sync_time (id, is_deleted, no, seconds, state) FROM stdin;
\.
...
COPY testnet.extra_key_witness (id, is_deleted, hash, tx_id) FROM stdin;
\.
...
COPY testnet.ma_tx_mint (id, is_deleted, quantity, ident, tx_id) FROM stdin;
\.
...
COPY testnet.ma_tx_out (id, is_deleted, quantity, ident, tx_out_id) FROM stdin;
\.
...
COPY testnet.meta (id, is_deleted, network_name, start_time, version) FROM stdin;
\.
...
COPY testnet.multi_asset (id, is_deleted, fingerprint, name, policy, supply, tx_count) FROM stdin;
\.
...
COPY testnet.pool_hash (id, is_deleted, hash_raw, pool_size, view) FROM stdin;
\.
...
COPY testnet.pool_metadata_ref (id, is_deleted, hash, url, pool_id, registered_tx_id) FROM stdin;
\.
...
COPY testnet.pool_offline_data (id, is_deleted, bytes, hash, json, ticker_name, pool_id, pmr_id) FROM stdin;
\.
...
COPY testnet.pool_offline_fetch_error (id, is_deleted, fetch_error, fetch_time, retry_count, pool_id, pmr_id) FROM stdin;
\.
...
COPY testnet.pool_owner (id, is_deleted, pool_update_id, addr_id) FROM stdin;
\.
...
COPY testnet.pool_relay (id, is_deleted, dns_name, dns_srv_name, ipv4, ipv6, port, update_id) FROM stdin;
\.
...
COPY testnet.pool_retire (id, is_deleted, cert_index, retiring_epoch, announced_tx_id, hash_id) FROM stdin;
\.
...
COPY testnet.pool_stake (id, is_deleted, amount, pool_id) FROM stdin;
\.
...
COPY testnet.pool_update (id, is_deleted, active_epoch_no, cert_index, fixed_cost, margin, pledge, vrf_key_hash, meta_id, hash_id, registered_tx_id, reward_addr_id) FROM stdin;
\.
...
COPY testnet.pot_transfer (id, is_deleted, cert_index, reserves, treasury, tx_id) FROM stdin;
\.
...
COPY testnet.redeemer (id, is_deleted, fee, index, purpose, script_hash, unit_mem, unit_steps, redeemer_data_id, tx_id) FROM stdin;
\.
...
COPY testnet.redeemer_data (id, is_deleted, bytes, hash, value, tx_id) FROM stdin;
\.
...
COPY testnet.reference_tx_in (id, is_deleted, tx_out_index, tx_in_id, tx_out_id) FROM stdin;
\.
...
COPY testnet.reserve (id, is_deleted, amount, cert_index, addr_id, tx_id) FROM stdin;
\.
...
COPY testnet.reserved_pool_ticker (id, is_deleted, name, pool_hash) FROM stdin;
\.
...
COPY testnet.reward (id, is_deleted, amount, earned_epoch, spendable_epoch, type, addr_id, pool_id) FROM stdin;
\.
...
COPY testnet.schema_version (id, is_deleted, stage_one, stage_three, stage_two) FROM stdin;
\.
...
COPY testnet.script (id, is_deleted, bytes, hash, json, serialised_size, type, tx_id) FROM stdin;
\.
...
COPY testnet.slot_leader (id, is_deleted, description, hash, pool_hash_id) FROM stdin;
...
COPY testnet.stake_address (id, is_deleted, hash_raw, script_hash, view, tx_id) FROM stdin;
\.
...
COPY testnet.stake_deregistration (id, is_deleted, cert_index, epoch_no, addr_id, redeemer_id, tx_id) FROM stdin;
\.
...
COPY testnet.stake_registration (id, is_deleted, cert_index, epoch_no, addr_id, tx_id) FROM stdin;
\.
...
COPY testnet.treasury (id, is_deleted, amount, cert_index, addr_id, tx_id) FROM stdin;
\.
...
COPY testnet.tx (id, is_deleted, block_id, block_index, deposit, fee, hash, invalid_before, invalid_hereafter, out_sum, script_size, size, valid_contract) FROM stdin;
...
COPY testnet.tx_in (id, is_deleted, tx_in_id, tx_out_index, tx_out_id, redeemer_id) FROM stdin;
\.
...
COPY testnet.tx_metadata (id, is_deleted, bytes, json, key, tx_id) FROM stdin;
\.
...
COPY testnet.withdrawal (id, is_deleted, amount, addr_id, redeemer_id, tx_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('testnet.ada_pots_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.block_id_seq', 1, true);
...
SELECT pg_catalog.setval('testnet.cost_model_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.datum_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.delegation_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.delisted_pool_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.epoch_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.epoch_param_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.epoch_stake_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.epoch_sync_time_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.extra_key_witness_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.ma_tx_mint_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.ma_tx_out_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.meta_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.multi_asset_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.param_proposal_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_hash_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_metadata_ref_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_offline_data_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_offline_fetch_error_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_owner_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_relay_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_retire_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_stake_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pool_update_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.pot_transfer_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.redeemer_data_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.redeemer_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.reference_tx_in_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.reserve_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.reserved_pool_ticker_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.reward_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.schema_version_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.script_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.slot_leader_id_seq', 1, true);
...
SELECT pg_catalog.setval('testnet.stake_address_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.stake_deregistration_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.stake_registration_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.treasury_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.tx_id_seq', 207, true);
...
SELECT pg_catalog.setval('testnet.tx_in_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.tx_metadata_id_seq', 1, false);


--
-- Name: failed_tx_out_id_seq; Type: SEQUENCE SET; Schema: dev; Owner: cardano-master
--

SELECT pg_catalog.setval('testnet.failed_tx_out_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.tx_out_id_seq', 207, true);


--
-- Name: unconsume_tx_in_id_seq; Type: SEQUENCE SET; Schema: dev; Owner: cardano-master
--

SELECT pg_catalog.setval('testnet.unconsume_tx_in_id_seq', 1, false);
...
SELECT pg_catalog.setval('testnet.withdrawal_id_seq', 1, false);
...
ALTER TABLE ONLY testnet.ada_pots
...
ALTER TABLE ONLY testnet.block
...
ALTER TABLE ONLY testnet.cost_model
...
ALTER TABLE ONLY testnet.datum
...
ALTER TABLE ONLY testnet.delegation
...
ALTER TABLE ONLY testnet.delisted_pool
...
ALTER TABLE ONLY testnet.epoch_param
...
ALTER TABLE ONLY testnet.epoch
...
ALTER TABLE ONLY testnet.epoch_stake
...
ALTER TABLE ONLY testnet.epoch_sync_time
...
ALTER TABLE ONLY testnet.extra_key_witness
...
ALTER TABLE ONLY testnet.ma_tx_mint
...
ALTER TABLE ONLY testnet.ma_tx_out
...
ALTER TABLE ONLY testnet.multi_asset
...
ALTER TABLE ONLY testnet.param_proposal
...
ALTER TABLE ONLY testnet.pool_hash
...
ALTER TABLE ONLY testnet.pool_metadata_ref
...
ALTER TABLE ONLY testnet.pool_offline_data
...
ALTER TABLE ONLY testnet.pool_offline_fetch_error
...
ALTER TABLE ONLY testnet.pool_owner
...
ALTER TABLE ONLY testnet.pool_relay
...
ALTER TABLE ONLY testnet.pool_retire
...
ALTER TABLE ONLY testnet.pool_stake
...
ALTER TABLE ONLY testnet.pool_update
...
ALTER TABLE ONLY testnet.pot_transfer
...
ALTER TABLE ONLY testnet.redeemer_data
...
ALTER TABLE ONLY testnet.redeemer
...
ALTER TABLE ONLY testnet.reference_tx_in
...
ALTER TABLE ONLY testnet.reserve
...
ALTER TABLE ONLY testnet.reserved_pool_ticker
...
ALTER TABLE ONLY testnet.reward
...
ALTER TABLE ONLY testnet.schema_version
...
ALTER TABLE ONLY testnet.script
...
ALTER TABLE ONLY testnet.slot_leader
...
ALTER TABLE ONLY testnet.stake_address
...
ALTER TABLE ONLY testnet.stake_deregistration
...
ALTER TABLE ONLY testnet.stake_registration
...
ALTER TABLE ONLY testnet.treasury
...
ALTER TABLE ONLY testnet.tx_in
...
ALTER TABLE ONLY testnet.tx_metadata
    ADD CONSTRAINT tx_metadata_pkey PRIMARY KEY (id);


--
-- Name: failed_tx_out failed_tx_out_pkey; Type: CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out
...
ALTER TABLE ONLY testnet.tx_out
...
--
-- Name: unconsume_tx_in unconsume_tx_in_pkey; Type: CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.unconsume_tx_in
...
--
-- Name: unconsume_tx_in unique_col_txin; Type: CONSTRAINT; Schema: dev; Owner: cardano-master
--
...
--
-- Name: failed_tx_out unique_col_txout_fail; Type: CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out
    ADD CONSTRAINT unique_col_txout_fail UNIQUE (tx_id, index);
...
--
-- Name: tx_in unique_txin; Type: CONSTRAINT; Schema: dev; Owner: cardano-master
--
...
ALTER TABLE ONLY testnet.withdrawal
...
ALTER TABLE ONLY testnet.ada_pots
    ADD CONSTRAINT ada_pots_block_id_fkey FOREIGN KEY (block_id) REFERENCES testnet.block(id) ON DELETE CASCADE;


--
-- Name: failed_tx_out collateral_tx_out_inline_datum_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out
    ADD CONSTRAINT collateral_tx_out_inline_datum_id_fkey FOREIGN KEY (inline_datum_id) REFERENCES testnet.datum(id) ON DELETE CASCADE;


--
-- Name: failed_tx_out collateral_tx_out_reference_script_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out
    ADD CONSTRAINT collateral_tx_out_reference_script_id_fkey FOREIGN KEY (reference_script_id) REFERENCES testnet.script(id) ON DELETE CASCADE;


--
-- Name: failed_tx_out collateral_tx_out_stake_address_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out
    ADD CONSTRAINT collateral_tx_out_stake_address_id_fkey FOREIGN KEY (stake_address_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;


--
-- Name: failed_tx_out collateral_tx_out_tx_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.failed_tx_out
    ADD CONSTRAINT collateral_tx_out_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.cost_model
    ADD CONSTRAINT cost_model_block_id_fkey FOREIGN KEY (block_id) REFERENCES testnet.block(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.datum
    ADD CONSTRAINT datum_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.delegation
    ADD CONSTRAINT delegation_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.delegation
    ADD CONSTRAINT delegation_pool_hash_id_fkey FOREIGN KEY (pool_hash_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.delegation
    ADD CONSTRAINT delegation_redeemer_id_fkey FOREIGN KEY (redeemer_id) REFERENCES testnet.redeemer(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.delegation
    ADD CONSTRAINT delegation_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.epoch_param
    ADD CONSTRAINT epoch_param_block_id_fkey FOREIGN KEY (block_id) REFERENCES testnet.block(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.epoch_param
    ADD CONSTRAINT epoch_param_cost_model_id_fkey FOREIGN KEY (cost_model_id) REFERENCES testnet.cost_model(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.epoch_stake
    ADD CONSTRAINT epoch_stake_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.epoch_stake
    ADD CONSTRAINT epoch_stake_pool_id_fkey FOREIGN KEY (pool_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.extra_key_witness
    ADD CONSTRAINT extra_key_witness_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.slot_leader
    ADD CONSTRAINT fk23db3v8n6dl1gf0njxgpceviq FOREIGN KEY (pool_hash_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.block
    ADD CONSTRAINT fk6gd608i8qbyert1hlfl9be71h FOREIGN KEY (previous_id) REFERENCES testnet.block(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.block
    ADD CONSTRAINT fke45qmlh5if6ghcyj0mhumjhk1 FOREIGN KEY (slot_leader_id) REFERENCES testnet.slot_leader(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_stake
    ADD CONSTRAINT fknipbg0qr651vyttfseohc94ql FOREIGN KEY (pool_id) REFERENCES testnet.pool_hash(id);
...
ALTER TABLE ONLY testnet.ma_tx_mint
    ADD CONSTRAINT ma_tx_mint_ident_fkey FOREIGN KEY (ident) REFERENCES testnet.multi_asset(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.ma_tx_mint
    ADD CONSTRAINT ma_tx_mint_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.ma_tx_out
    ADD CONSTRAINT ma_tx_out_ident_fkey FOREIGN KEY (ident) REFERENCES testnet.multi_asset(id) ON DELETE CASCADE;


--
-- Name: ma_tx_out ma_tx_out_tx_out_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.ma_tx_out
    ADD CONSTRAINT ma_tx_out_tx_out_id_fkey FOREIGN KEY (tx_out_id) REFERENCES testnet.tx_out(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.param_proposal
    ADD CONSTRAINT param_proposal_cost_model_id_fkey FOREIGN KEY (cost_model_id) REFERENCES testnet.cost_model(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.param_proposal
    ADD CONSTRAINT param_proposal_registered_tx_id_fkey FOREIGN KEY (registered_tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_metadata_ref
    ADD CONSTRAINT pool_metadata_ref_pool_id_fkey FOREIGN KEY (pool_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_metadata_ref
    ADD CONSTRAINT pool_metadata_ref_registered_tx_id_fkey FOREIGN KEY (registered_tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_offline_data
    ADD CONSTRAINT pool_offline_data_pmr_id_fkey FOREIGN KEY (pmr_id) REFERENCES testnet.pool_metadata_ref(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_offline_data
    ADD CONSTRAINT pool_offline_data_pool_id_fkey FOREIGN KEY (pool_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_offline_fetch_error
    ADD CONSTRAINT pool_offline_fetch_error_pmr_id_fkey FOREIGN KEY (pmr_id) REFERENCES testnet.pool_metadata_ref(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_offline_fetch_error
    ADD CONSTRAINT pool_offline_fetch_error_pool_id_fkey FOREIGN KEY (pool_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_owner
    ADD CONSTRAINT pool_owner_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_owner
    ADD CONSTRAINT pool_owner_pool_update_id_fkey FOREIGN KEY (pool_update_id) REFERENCES testnet.pool_update(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_relay
    ADD CONSTRAINT pool_relay_update_id_fkey FOREIGN KEY (update_id) REFERENCES testnet.pool_update(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_retire
    ADD CONSTRAINT pool_retire_announced_tx_id_fkey FOREIGN KEY (announced_tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_retire
    ADD CONSTRAINT pool_retire_hash_id_fkey FOREIGN KEY (hash_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_update
    ADD CONSTRAINT pool_update_hash_id_fkey FOREIGN KEY (hash_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_update
    ADD CONSTRAINT pool_update_meta_id_fkey FOREIGN KEY (meta_id) REFERENCES testnet.pool_metadata_ref(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_update
    ADD CONSTRAINT pool_update_registered_tx_id_fkey FOREIGN KEY (registered_tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pool_update
    ADD CONSTRAINT pool_update_reward_addr_id_fkey FOREIGN KEY (reward_addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.pot_transfer
    ADD CONSTRAINT pot_transfer_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.redeemer_data
    ADD CONSTRAINT redeemer_data_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.redeemer
    ADD CONSTRAINT redeemer_redeemer_data_id_fkey FOREIGN KEY (redeemer_data_id) REFERENCES testnet.redeemer_data(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.redeemer
    ADD CONSTRAINT redeemer_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.reference_tx_in
    ADD CONSTRAINT reference_tx_in_tx_in_id_fkey FOREIGN KEY (tx_in_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.reference_tx_in
    ADD CONSTRAINT reference_tx_in_tx_out_id_fkey FOREIGN KEY (tx_out_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.reserve
    ADD CONSTRAINT reserve_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.reserve
    ADD CONSTRAINT reserve_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.reward
    ADD CONSTRAINT reward_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.reward
    ADD CONSTRAINT reward_pool_id_fkey FOREIGN KEY (pool_id) REFERENCES testnet.pool_hash(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.script
    ADD CONSTRAINT script_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.stake_address
    ADD CONSTRAINT stake_address_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.stake_deregistration
    ADD CONSTRAINT stake_deregistration_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.stake_deregistration
    ADD CONSTRAINT stake_deregistration_redeemer_id_fkey FOREIGN KEY (redeemer_id) REFERENCES testnet.redeemer(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.stake_deregistration
    ADD CONSTRAINT stake_deregistration_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.stake_registration
    ADD CONSTRAINT stake_registration_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.stake_registration
    ADD CONSTRAINT stake_registration_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.treasury
    ADD CONSTRAINT treasury_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.treasury
    ADD CONSTRAINT treasury_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx
    ADD CONSTRAINT tx_block_id_fkey FOREIGN KEY (block_id) REFERENCES testnet.block(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_in
    ADD CONSTRAINT tx_in_redeemer_id_fkey FOREIGN KEY (redeemer_id) REFERENCES testnet.redeemer(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_in
    ADD CONSTRAINT tx_in_tx_in_id_fkey FOREIGN KEY (tx_in_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_in
    ADD CONSTRAINT tx_in_tx_out_id_fkey FOREIGN KEY (tx_out_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_metadata
    ADD CONSTRAINT tx_metadata_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_out
    ADD CONSTRAINT tx_out_inline_datum_id_fkey FOREIGN KEY (inline_datum_id) REFERENCES testnet.datum(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_out
    ADD CONSTRAINT tx_out_reference_script_id_fkey FOREIGN KEY (reference_script_id) REFERENCES testnet.script(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_out
    ADD CONSTRAINT tx_out_stake_address_id_fkey FOREIGN KEY (stake_address_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.tx_out
    ADD CONSTRAINT tx_out_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;


--
-- Name: unconsume_tx_in unsconume_tx_in_tx_in_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.unconsume_tx_in
    ADD CONSTRAINT unsconume_tx_in_tx_in_id_fkey FOREIGN KEY (tx_in_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;


--
-- Name: unconsume_tx_in unsconume_tx_in_tx_out_id_fkey; Type: FK CONSTRAINT; Schema: dev; Owner: cardano-master
--

ALTER TABLE ONLY testnet.unconsume_tx_in
    ADD CONSTRAINT unsconume_tx_in_tx_out_id_fkey FOREIGN KEY (tx_out_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.withdrawal
    ADD CONSTRAINT withdrawal_addr_id_fkey FOREIGN KEY (addr_id) REFERENCES testnet.stake_address(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.withdrawal
    ADD CONSTRAINT withdrawal_redeemer_id_fkey FOREIGN KEY (redeemer_id) REFERENCES testnet.redeemer(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY testnet.withdrawal
    ADD CONSTRAINT withdrawal_tx_id_fkey FOREIGN KEY (tx_id) REFERENCES testnet.tx(id) ON DELETE CASCADE;
