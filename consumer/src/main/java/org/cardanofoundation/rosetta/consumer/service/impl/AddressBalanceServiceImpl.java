...
import static org.cardanofoundation.rosetta.consumer.constant.ConsumerConstant.ADDRESS_TOKEN_BALANCE_BATCH_QUERY_SIZE;
...
public class AddressBalanceServiceImpl implements AddressBalanceService {
  ...
  public void handleAddressBalance(
    ...
    aggregatedAddressBalanceMap.forEach((address, aggregatedAddressBalance) -> {
      ...
      Address addressEntity = addressMap.computeIfAbsent(address,
          s -> buildNewAddressEntity(aggregatedAddressBalance, stakeAddress));
