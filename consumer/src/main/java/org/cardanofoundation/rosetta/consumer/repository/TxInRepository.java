...
import org.cardanofoundation.rosetta.consumer.projection.LatestTxInProjection;
...
public interface TxInRepository extends JpaRepository<TxIn, Long> {
  ...
  @Query("SELECT "
      + "new org.cardanofoundation.rosetta.consumer.projection.LatestTxInProjection("
      + "txIn.txInput.id, "
      + "txOut.address"
      + ") FROM TxIn txIn "
