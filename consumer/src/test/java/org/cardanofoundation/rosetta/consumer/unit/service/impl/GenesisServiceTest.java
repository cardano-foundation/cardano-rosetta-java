...
import org.cardanofoundation.rosetta.consumer.service.impl.genesis.GenesisLocalFetching;
import org.cardanofoundation.rosetta.consumer.service.impl.genesis.GenesisWebClientFetching;
...
import static org.cardanofoundation.rosetta.consumer.service.impl.genesis.GenesisDataServiceImpl.COIN_PER_BYTE;
...
class GenesisServiceTest {
  ...
  void testGenesisMainnetInternetFetching() {
    ...
    EpochParam alonzoGenesis = EpochParam.builder()
            ...
            .minUtxoValue(null)
            .build();
    Assertions.assertEquals(alonzoGenesis.toString(), data.getAlonzo().toString());
    // babbage protocol
  ...
  void testGenesisPreprodInternetFetching() {
    ...
    EpochParam alonzoGenesis = EpochParam.builder()
            ...
            .minUtxoValue(null)
            .build();
    System.out.println("alonzo is " + data.getAlonzo());
    Assertions.assertEquals(alonzoGenesis.toString(), data.getAlonzo().toString());
    // babbage protocol
    EpochParam babbageGenesis = EpochParam.builder()
            .coinsPerUtxoSize(BigInteger.valueOf(COIN_PER_BYTE))
