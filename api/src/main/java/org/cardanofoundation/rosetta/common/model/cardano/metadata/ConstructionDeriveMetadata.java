...
@AllArgsConstructor
@NoArgsConstructor
public class ConstructionDeriveMetadata {
  ...
  public static ConstructionDeriveMetadata fromHashMap(HashMap<String, Object> metadata) {
    ConstructionDeriveMetadata deriveRequestMetadata = new ConstructionDeriveMetadata();
  ...
  public ConstructionDeriveMetadata stakingCredential(PublicKey stakingCredential) {
  ...
  */
  ...
  public ConstructionDeriveMetadata addressType(String addressType) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ConstructionDeriveMetadata constructionDeriveRequestMetadata = (ConstructionDeriveMetadata) o;
