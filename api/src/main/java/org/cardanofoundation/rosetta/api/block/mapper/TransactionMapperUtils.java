...
public class TransactionMapperUtils {
  ...
  public OperationMetadata mapToOperationMetaData(boolean spent, List<Amt> amounts) {
    ...
    Set<String> subjects = nonAdaAmounts.stream()
            .map(amount -> amount.getPolicyId() + amount.getAssetName())
  ...
  private static Amount extractAmount(boolean spent, String policyId, Amt amount, Map<String, Optional<TokenSubject>> tokenMetadataMap) {
