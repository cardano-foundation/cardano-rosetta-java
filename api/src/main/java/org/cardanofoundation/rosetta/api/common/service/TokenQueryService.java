...
public class TokenQueryService {
    ...
    /**
     * Applies CIP-26 fields (and optionally logo) to the builder. Leaves decimals null if the
     * source does not provide it; downstream mappers apply the default of 0.
     */
