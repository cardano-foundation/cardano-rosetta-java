...
public class BlockParsingErrorNotificationService {
    ...
    private void checkBlockParsingErrors() {
        ...
        if (!unreviewed.isEmpty()) {
            log.error("You have unreviewed block parsing errors found in the database table: 'error', please check if you are affected via endpoint: /call/."); // TODO name of the endpoint
        }
    }
