...
public class ConstructionApiServiceImpl implements ConstructionApiService {
  ...
  public ConstructionMetadataResponse constructionMetadataService(
    ...
    //long prevTTl = offlineSlotService.getCurrentSlotBasedOnTime() + relativeTtl;

    //log.info("[constructionMetadata] prevTTl:{}", prevTTl);
    ...
    //Long updatedTxSize = cardanoConstructionService.updateTxSize((long) txSize, prevTTl, ttl);
