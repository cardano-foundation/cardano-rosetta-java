...
public class LedgerBlockServiceImpl implements LedgerBlockService {
  ...
  @Value("${cardano.rosetta.PRUNING_SAFE_BLOCKS:2160}")
  private int pruningSafeBlocksCount;
  ...
  public BlockIdentifierExtended findOldestBlockIdentifier(BlockIdentifierExtended latestBlock) {
    ...
    long targetBlockNo = latestBlock.getNumber() - pruningSafeBlocksCount; // this could result in less than 0
