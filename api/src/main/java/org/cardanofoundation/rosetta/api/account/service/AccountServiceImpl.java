...
public class AccountServiceImpl implements AccountService {
  ...
  private final AddressBalanceMapperImpl stakeAccountInfoToAddressBalanceMapperService;
    ...
    return findBlockOrLast(number, hash)
            .map(blockDto -> {
              ...
              if (isStakeAddress(address)) {
                ...
                balances = List.of(stakeAccountInfoToAddressBalanceMapperService.convertToAdaAddressBalance(stakeAccountInfo, blockDto.getNumber()));
              } else {
