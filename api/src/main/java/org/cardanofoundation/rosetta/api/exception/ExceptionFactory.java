...
public class ExceptionFactory {
  ...
  public static ApiException invalidAddressError(String address) {
    return new ApiException(
        RosettaErrorType
            .INVALID_ADDRESS.toRosettaError(
                true,
  ...
  public static ApiException transactionInputsParametersMissingError(Object error) {
    return new ApiException(
        RosettaErrorType.TRANSACTION_INPUTS_PARAMETERS_MISSING_ERROR.toRosettaError(false, error));
  }

  public static ApiException transactionOutputDeserializationError(Object error) {
    return new ApiException(
        RosettaErrorType.TRANSACTION_OUTPUT_DESERIALIZATION_ERROR.toRosettaError(false, error));
  }

  public static ApiException transactionOutputsParametersMissingError(Object error) {
    return new ApiException(
        RosettaErrorType.TRANSACTION_OUTPUTS_PARAMETERS_MISSING_ERROR.toRosettaError(false, error));
  }
