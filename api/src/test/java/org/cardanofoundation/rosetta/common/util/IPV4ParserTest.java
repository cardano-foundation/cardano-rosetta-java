...
class IPV4ParserTest {
    ...
    class ParseIpv4Tests {
        ...
        void shouldParseValidIpv4() throws UnknownHostException {
            Inet4Address result = IPV4Parser.parseIpv4("127.0.0.1");
        ...
        void shouldFailForNullIpv4() {
            assertThatThrownBy(() -> IPV4Parser.parseIpv4(null))
        ...
        void shouldFailForMalformedIpv4() {
            assertThatThrownBy(() -> IPV4Parser.parseIpv4("300.0.1"))
        ...
        void shouldFailForNonNumericIpv4() {
            assertThatThrownBy(() -> IPV4Parser.parseIpv4("127.a.0.1"))
                    .isInstanceOf(NumberFormatException.class);
        }
    }
    ...
    class ParseIpv6Tests {
        ...
        void shouldParseValidIpv61() throws UnknownHostException {
            ...
            Inet6Address result = IPV4Parser.parseIpv6("00000000000000000000000000000001");
        ...
        void shouldParseValidIpv62() throws UnknownHostException {
            // Example: "::1" -> 00000000000000000000000000000001
            Inet6Address result = IPV4Parser.parseIpv6("2001:0db8:85a3:0000:0000:8a2e:0370:7334");
            assertThat(result).isInstanceOf(Inet6Address.class);
        ...
        void shouldFailForNullIpv6() {
            assertThatThrownBy(() -> IPV4Parser.parseIpv6(null))
                    .isInstanceOf(UnknownHostException.class)
                    .hasMessage("Error Parsing IP Address");
        }
        ...
        void shouldFailForInvalidHexIpv6() {
            assertThatThrownBy(() -> IPV4Parser.parseIpv6("ZZZZ::ZZZZ"))
        ...
        void shouldFailForInvalidLengthIpv6() {
            assertThatThrownBy(() -> IPV4Parser.parseIpv6("0001")) // Only 2 bytes, should be 16
                    .isInstanceOf(UnknownHostException.class);
        }
    }
