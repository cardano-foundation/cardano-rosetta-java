    ...
    class ConversionTests {
        ...
        void shouldConvertToCborMapAndBackSuccessfully() {
            ...
            assertThat(convertedOperation.getAccount().getAddress())
                    .isEqualTo(operation.getAccount().getAddress());
            assertThat(convertedOperation.getAccount().getSubAccount())
                    .isEqualTo(operation.getAccount().getSubAccount());
            assertThat(convertedOperation.getOperationIdentifier())
                    .isEqualTo(operation.getOperationIdentifier());
            assertThat(convertedOperation.getMetadata().getPoolRegistrationParams().getPoolOwners())
                    .isEqualTo(operation.getMetadata().getPoolRegistrationParams().getPoolOwners());
            assertThat(convertedOperation.getMetadata().getPoolRegistrationParams().getRelays().getFirst().getDnsName())
                    .isEqualTo(operation.getMetadata().getPoolRegistrationParams().getRelays().getFirst().getDnsName());
            assertThat(convertedOperation.getMetadata().getPoolRegistrationParams().getMargin())
                    .isEqualTo(operation.getMetadata().getPoolRegistrationParams().getMargin());
            assertThat(convertedOperation.getMetadata().getPoolRegistrationParams().getPoolMetadata())
                    .isEqualTo(operation.getMetadata().getPoolRegistrationParams().getPoolMetadata());
        }
    }
