...
public class NetworkApiDelegateImplOptionsTest extends IntegrationTestWithDB {

  @BeforeEach
  public void setUp() {
    baseUrl = baseUrl.concat(":").concat(String.valueOf(serverPort)).concat("/network/options");
  }
  ...
  void test_when_request_with_valid_payload_should_return_object_containing_proper_version_information() {
    ...
    ResponseEntity<NetworkOptionsResponse> responseEntity = restTemplate.postForEntity(baseUrl,
        requestEntity,
  ...
  void test_when_request_with_valid_payload_should_return_object_containing_proper_allow_information() {
    ...
    BalanceExemption balanceExemption1 = new BalanceExemption().exemptionType(
        ExemptionType.GREATER_OR_EQUAL);
    BalanceExemption balanceExemption2 = new BalanceExemption().exemptionType(
        ExemptionType.LESS_OR_EQUAL);
    BalanceExemption balanceExemption3 = new BalanceExemption().exemptionType(
        ExemptionType.DYNAMIC);
