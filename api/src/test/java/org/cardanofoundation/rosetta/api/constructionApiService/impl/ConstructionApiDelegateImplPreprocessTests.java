...
//        .concat("/construction/preprocess");
//  }
//
...
//    assertEquals(TestFixedData.TRANSACTION_SIZE_IN_BYTES,
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_an_input_with_a_byron_address()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY + "/construction_preprocess_request_ttl_valid.json"))),
//        ConstructionPreprocessRequest.class);
...
//                + "/construction_preprocess_throw_an_error_when_invalid_inputs_are_sent_as_parameters.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
...
//
//  @Test
//  void test_should_return_a_valid_TTL_when_the_operations_include_stake_key_registration()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_return_a_valid_ttl_when_the_operations_include_stake_key_registration.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_STAKE_KEY_REGISTRATION),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_pool_retirement()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(
//                BASE_DIRECTORY + "/construction_preprocess_operations_include_pool_retirement.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_POOL_RETIREMENT),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_stake_key_deregistration()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_operations_include_stake_key_deregistration.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_STAKE_KEY_DEREGISTRATION),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_stake_delegation()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(
//                BASE_DIRECTORY + "/construction_preprocess_operations_include_stake_delegation.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_STAKE_DELEGATION),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_stake_key_registration_and_stake_delegation()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_operations_include_stake_key_and_stake_delegation.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
...
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(
//        sizeInBytes(TestFixedData.SIGNED_TX_WITH_STAKE_KEY_REGISTRATION_AND_STAKE_DELEGATION),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
...
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_WITHDRAWAL),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_two_withdrawals()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(
//                BASE_DIRECTORY + "/construction_preprocess_operations_include_two_withdrawals.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_TWO_WITHDRAWALS),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
//  void test_should_return_a_valid_ttl_when_the_operations_include_two_withdrawal_and_stake_key_registration()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_operations_include_two_withdrawal_and_stake_key_registration.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_STAKE_KEY_REGISTRATION_AND_WITHDRAWAL),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
...
//    assertEquals(TestFixedData.TRANSACTION_SIZE_IN_BYTES,
//        constructionPreprocessResponse.getOptions()
//            .getTransactionSize());
//  }
//
//  @Test
...
//
//  @Test
//  void test_should_properly_process_multiassets_transactions_with_several_tokens()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_assets_transaction_with_several_tokens.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_MULTIPLE_MA),
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_assets_transaction_with_tokens_without_name.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_MA_WITHOUT_NAME),
//        constructionPreprocessResponse.getOptions().getTransactionSize());
//  }
//
//  @Test
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_assets_policy_id_is_shorter_than_expected.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_assets_policy_id_is_longer_than_expected.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_assets_policy_id_is_not_the_hex_string.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_asset_symbol_longer_than_expected.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_asset_symbol_is_not_a_hex_string.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_multi_asset_value_for_output_operation_is_negative.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate
...
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(
//                BASE_DIRECTORY + "/construction_preprocess_multi_asset_value_is_not_number.json"))),
//        ConstructionPreprocessRequest.class);
//
//    try {
//      ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate
...
//
//  @Test
//  void test_should_process_properly_process_transactions_with_pool_registrations_with_pledge()
//      throws IOException {
//    ConstructionPreprocessRequest request = objectMapper.readValue(new String(Files.readAllBytes(
//            Paths.get(BASE_DIRECTORY
//                + "/construction_preprocess_transactions_with_pool_registrations_with_pledge.json"))),
//        ConstructionPreprocessRequest.class);
//
//    ConstructionPreprocessResponse constructionPreprocessResponse = restTemplate.postForObject(
//        baseUrl, request, ConstructionPreprocessResponse.class);
//
//    assertEquals(100, constructionPreprocessResponse.getOptions().getRelativeTtl());
//    assertEquals(sizeInBytes(TestFixedData.SIGNED_TX_WITH_POOL_REGISTRATION_AND_PLEDGE),
//        constructionPreprocessResponse
//            .getOptions().getTransactionSize());
//  }
//
