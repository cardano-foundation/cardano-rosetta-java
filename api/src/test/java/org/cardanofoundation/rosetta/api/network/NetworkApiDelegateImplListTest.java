...
public class NetworkApiDelegateImplListTest extends IntegrationTestWithDB {

  @BeforeEach
  public void setUp() {
    baseUrl = baseUrl.concat(":").concat(String.valueOf(serverPort)).concat("/network/list");
  }
  ...
  void test_when_request_with_an_empty_request_body_should_return_an_array_of_one_element_equal_to_cardano_mainnet() {
    ...
    NetworkListResponse actualResponse = restTemplate.postForObject(baseUrl, request,
