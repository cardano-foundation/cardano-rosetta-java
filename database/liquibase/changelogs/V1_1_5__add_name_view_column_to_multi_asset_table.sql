...
ALTER TABLE multi_asset ADD COLUMN name_view varchar(64);
UPDATE multi_asset SET name_view = pg_temp.asset_name_bytea_to_name_view(name);
ALTER TABLE multi_asset ALTER COLUMN name_view SET NOT NULL;
