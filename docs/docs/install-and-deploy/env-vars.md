...
| `CARDANO_NODE_VERSION`                        | Cardano node version                                                  | 11.1.2                                 | added in release 1.0.0  |
...
| `RELEASE_VERSION`                             | Docker image tag for API and Indexer images                           | 2.3.1                                  | added in release 2.0.0  |
