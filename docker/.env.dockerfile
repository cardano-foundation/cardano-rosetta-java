...
## Performance tuning
DB_POOL_MIN_COUNT=10
DB_POOL_MAX_COUNT=10
DB_POOL_MAX_LIFETIME_MS=2000000
DB_POOL_CONNECTION_TIMEOUT_MS=100000
DB_KEEP_ALIVE_MS=60000
DB_LEAK_CONNECTIONS_WARNING_MS=60000
DB_MONITOR_PERFORMANCE=false
